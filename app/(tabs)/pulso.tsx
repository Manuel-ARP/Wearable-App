...
const dayPulse = dayLabels.map((_, i) => 70 + Math.sin(i / 2) * 6 + (i % 6 === 0 ? 5 : 0));
...
const dataSets = {
  ...
  mes: {
    label: 'Pulso (PPM)',
    values: [68, 72, 70, 75, 69, 73, 71, 74, 70, 72],
    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        <View style={styles.headerRow}>
          ...
          <Text style={styles.header}>Pulso</Text>
          <View style={{ width: 22 }} />
        </View>
        ...
        <View style={styles.card}>
          <Text style={styles.cardTitle}>Tendencia de datos - Pulso (PPM)</Text>
        ...
        <View style={styles.cardsRow}>
          <View style={styles.infoCard}>
            ...
            <View style={{ flex: 1 }}>
              <Text style={styles.infoLabel}>Promedio Semanal</Text>
          ...
          <View style={styles.infoCard}>
            ...
            <View style={{ flex: 1 }}>
              <Text style={styles.infoLabel}>Pulso en Reposo</Text>
